...
| `1051006` | Running on `gpu-beast` / 01:08:31 at latest check | Q3 S-shuffle LR-control, real-label fraction 50%, locked real test | Pure Gaussian NLL; init from `1051002`; real fine-tune LR `2e-5`; max 120 epochs; 2 GPUs | S-shuffle label-efficiency control |
| `1051007` | Running on `gpu-beast` / 00:11:38 at latest check | Q3 S-shuffle LR-control, real-label fraction 100%, locked real test | Pure Gaussian NLL; init from `1051002`; real fine-tune LR `2e-5`; max 120 epochs; 2 GPUs | S-shuffle label-efficiency control |
...
| `1051006` | S-shuffle LR-control | 50% | RUNNING on `gpu-beast` | `/home/rb3434w/CNN-age-inference/runs/q3_sshuffle_realfrac_f50_lr2e5_seed42_v2s_384` |
| `1051007` | S-shuffle LR-control | 100% | RUNNING on `gpu-beast` | `/home/rb3434w/CNN-age-inference/runs/q3_sshuffle_realfrac_f100_lr2e5_seed42_v2s_384` |
