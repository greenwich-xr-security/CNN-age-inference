...
| --- | ---: | --- | --- | --- |
| S-age, clean synthetic-only init, LR `2e-5` | 5% | `1050979` | Running | Match `1050819` fine-tuning LR/max epochs while keeping Q3 clean `1050939` synthetic-only init |
| S-age, clean synthetic-only init, LR `2e-5` | 10% | `1050980` | Running | Match `1050819` fine-tuning LR/max epochs while keeping Q3 clean `1050939` synthetic-only init |
| S-age, clean synthetic-only init, LR `2e-5` | 25% | `1050981` | Pending | Match `1050819` fine-tuning LR/max epochs while keeping Q3 clean `1050939` synthetic-only init |
| S-age, clean synthetic-only init, LR `2e-5` | 50% | `1050982` | Pending | Match `1050819` fine-tuning LR/max epochs while keeping Q3 clean `1050939` synthetic-only init |
...
| S-age LR-control | 5% | `1050979` | Running | - | - | - | - | - |
| S-age LR-control | 10% | `1050980` | Running | - | - | - | - | - |
| S-age LR-control | 25% | `1050981` | Pending | - | - | - | - | - |
| S-age LR-control | 50% | `1050982` | Pending | - | - | - | - | - |
