...
real_run="minpair_seed45_real_nll_v2s_384"
syn_run="minpair_seed45_realsyn2_nll_v2s_384"
real_ft_run="minpair_seed45_real_from_real_lr2e5_v2s_384"
syn_ft_run="minpair_seed45_real_from_syn2_lr2e5_v2s_384"

real_job="$(submit_train real "${real_run}" "${REAL_FOLD_FILE}" 0 29750)"
syn_job="$(submit_train syn2 "${syn_run}" "${SYN2_FOLD_FILE}" 1 29751)"
real_ft_job="$(submit_finetune real "${real_ft_run}" "${PROJECT_ROOT}/runs/${real_run}" "${real_job}" 29752)"
syn_ft_job="$(submit_finetune syn2 "${syn_ft_run}" "${PROJECT_ROOT}/runs/${syn_run}" "${syn_job}" 29753)"

echo "seed=45 real_train=${real_job} syn2_train=${syn_job} real_ft=${real_ft_job} syn2_ft=${syn_ft_job}"
