...
| `1055191` | Completed / 01:23:54 | Q4 S-age repeat seed 43; real only; uncapped fixed 20% test | Pure Gaussian NLL; fold-matched `1055190` initialisation; LR `2e-5`; max 120 epochs | Q4 staged synthetic-age arm fine-tune |
...
| `1055193` | Completed / 01:21:33 | Q4 S-age repeat seed 44; real only; uncapped fixed 20% test | Pure Gaussian NLL; fold-matched `1055192` initialisation; LR `2e-5`; max 120 epochs | Q4 staged synthetic-age arm fine-tune |
...
| `1055195` | Completed / 01:31:58 | Q4 S-age repeat seed 45; real only; uncapped fixed 20% test | Pure Gaussian NLL; fold-matched `1055194` initialisation; LR `2e-5`; max 120 epochs | Q4 staged synthetic-age arm fine-tune |
...
| `1055197` | Completed / 01:28:34 | Q4 S-age repeat seed 46; real only; uncapped fixed 20% test | Pure Gaussian NLL; fold-matched `1055196` initialisation; LR `2e-5`; max 120 epochs | Q4 staged synthetic-age arm fine-tune |
| `1055198` | Completed / 01:46:41 | Q4 S-age repeat seed 47; SyntheticDorsalHands2 only; fixed synthetic2 20% test | Pure Gaussian NLL; LR `2e-4`; checkpoint stage | Q4 staged synthetic-age arm checkpoint |
| `1055199` | Completed / 01:26:05 | Q4 S-age repeat seed 47; real only; uncapped fixed 20% test | Pure Gaussian NLL; fold-matched `1055198` initialisation; LR `2e-5`; max 120 epochs | Q4 staged synthetic-age arm fine-tune |
| `1055200` | Completed / 01:36:59 | Q4 S-age repeat seed 48; SyntheticDorsalHands2 only; fixed synthetic2 20% test | Pure Gaussian NLL; LR `2e-4`; checkpoint stage | Q4 staged synthetic-age arm checkpoint |
| `1055201` | Completed / 01:23:59 | Q4 S-age repeat seed 48; real only; uncapped fixed 20% test | Pure Gaussian NLL; fold-matched `1055200` initialisation; LR `2e-5`; max 120 epochs | Q4 staged synthetic-age arm fine-tune |
...
- Progress update at 2026-08-11 18:43 BST: seed 47 checkpoint job `1055198` COMPLETED after `01:46:41`; seed 48 checkpoint job `1055200` COMPLETED after `01:36:59`; seed 43 fine-tune `1055191` RUNNING for `01:17:30`; seed 44 fine-tune `1055193` RUNNING for `01:12:28`; seed 45-48 fine-tunes `1055195`, `1055197`, `1055199`, and `1055201` are PENDING for resources.
- Held-out checkpoint-stage results, five-fold unweighted `n=1` aggregate over 4,423 SyntheticDorsalHands2 held-out samples per fold: seed 47 synthetic-only checkpoint `1055198` MAE 3.452, RMSE 4.523, AUC 0.9811, mean FPR 4.56%, Adult FNR 7.15%; seed 48 synthetic-only checkpoint `1055200` MAE 3.461, RMSE 4.523, AUC 0.9771, mean FPR 4.85%, Adult FNR 7.27%.
- Progress update at 2026-08-11 19:37 BST: seed 43 fine-tune job `1055191` COMPLETED after `01:23:54`; seed 44 fine-tune job `1055193` COMPLETED after `01:21:33`; seed 45 fine-tune job `1055195` RUNNING for `00:47:57`; seed 46 fine-tune job `1055197` RUNNING for `00:44:49`; seed 47 and 48 fine-tunes `1055199` and `1055201` are PENDING for resources.
- Held-out fine-tuning results, five-fold unweighted `n=1` aggregate over 1,624 real held-out samples per fold: seed 43 S-age fine-tune `1055191` MAE 4.861, RMSE 6.564, AUC 0.9499, mean FPR 4.74%, Adult FNR 18.55%; seed 44 S-age fine-tune `1055193` MAE 4.919, RMSE 6.647, AUC 0.9517, mean FPR 4.74%, Adult FNR 19.41%.
- Progress update at 2026-08-11 20:03 BST: seed 45 fine-tune job `1055195` still RUNNING for `01:14:20`; seed 46 fine-tune job `1055197` still RUNNING for `01:11:12`; seed 47 and 48 fine-tunes `1055199` and `1055201` remain PENDING for resources. No additional real-test summaries are available yet beyond seeds 43 and 44.
- Progress update at 2026-08-11 20:27 BST: seed 45 fine-tune job `1055195` COMPLETED after `01:31:58`; seed 46 fine-tune job `1055197` COMPLETED after `01:28:34`; seed 47 fine-tune job `1055199` RUNNING for `00:06:14`; seed 48 fine-tune job `1055201` RUNNING for `00:06:44`.
- Held-out fine-tuning results, five-fold unweighted `n=1` aggregate over 1,624 real held-out samples per fold: seed 45 S-age fine-tune `1055195` MAE 4.834, RMSE 6.591, AUC 0.9558, mean FPR 4.74%, Adult FNR 18.40%; seed 46 S-age fine-tune `1055197` MAE 4.799, RMSE 6.498, AUC 0.9521, mean FPR 4.74%, Adult FNR 19.12%.
- Progress update at 2026-08-11 21:53 BST: seed 47 fine-tune job `1055199` COMPLETED after `01:26:05`; seed 48 fine-tune job `1055201` COMPLETED after `01:23:59`. All Q4 S-age seed 43-48 replacement jobs are complete.
- Held-out fine-tuning results, five-fold unweighted `n=1` aggregate over 1,624 real held-out samples per fold: seed 47 S-age fine-tune `1055199` MAE 4.863, RMSE 6.567, AUC 0.9507, mean FPR 4.74%, Adult FNR 19.97%; seed 48 S-age fine-tune `1055201` MAE 4.798, RMSE 6.507, AUC 0.9562, mean FPR 4.74%, Adult FNR 18.40%.
- Final three-arm Q4 seed-level summary over seeds 42-48: mean MAE is 5.007 for `R0`, 4.647 for `Pooled`, and 4.842 for `S-age`; mean RMSE is 6.936 for `R0`, 6.412 for `Pooled`, and 6.564 for `S-age`. `Pooled` has the lowest MAE in all seven paired seeds.
